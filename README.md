...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sankee-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12446&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sankee-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sankee` can be installed with:

```
conda install sankee
```

It is possible to list all of the versions of `sankee` available on your platform with:
